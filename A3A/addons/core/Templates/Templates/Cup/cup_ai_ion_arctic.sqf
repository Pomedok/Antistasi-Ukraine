...
["magazines", createHashMapFromArray [["CUP_B_M270_HE_BAF_WOOD", ["CUP_12Rnd_MLRS_HE"]]]] call _fnc_saveToTemplate; //element format: [Vehicle class, [Magazines]]
...
_sfLoadoutData set ["backpacks", ["CUP_B_AssaultPack_ACU"]];
...
_militaryLoadoutData set ["glVests", ["CUP_V_B_Armatus_BB_Black"]];
_militaryLoadoutData set ["engVests", ["CUP_V_B_Armatus_BB_Black"]];
_militaryLoadoutData set ["backpacks", ["CUP_B_AssaultPack_Black"]];
_militaryLoadoutData set ["slBackpacks", ["CUP_B_USPack_Black"]];
_militaryLoadoutData set ["atBackpacks", ["CUP_B_USPack_Black"]];
_militaryLoadoutData set ["helmets", ["CUP_H_PMC_Beanie_Winter"]];
_militaryLoadoutData set ["sniHats", ["CUP_H_PMC_Beanie_Headphones_Winter"]];
